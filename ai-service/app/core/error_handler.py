...
from app.core.errors import (
    BaseAIServiceError, ErrorCategory, SystemError, RateLimitError, 
    AuthError, NetworkError, AIServiceError
)
...
class ErrorResponse:
    ...
    def __init__(self, error: str, category: ErrorCategory, 
                 suggested_action: Optional[str] = None, retry_after: Optional[int] = None):
        self.success = False
        self.error = error
